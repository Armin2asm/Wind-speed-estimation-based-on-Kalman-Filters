...
%% Load Wind Data
wdata=xlsread('winddata4.5.xlsx')
index=1;
for z=1:34
    temp=wdata(:,2); % time wind 
    endindex=index+8;
    X=temp(index:endindex)
...
%=============================================
plot(time, x_hat_history(1,:), 'b', 'DisplayName', 'H-infinity Kalman filter','LineWidth',1.2)
    estimated_position3= x_hat_history(1,:);
...
difference3 = x_hat_history(1,:)'- true_state  ;
